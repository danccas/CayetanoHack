...
class Pagination {
  ...
  public function render() {
    ...
    $link = !is_null($this->link) ? $this->link : Route::link(null, DOMINIO_ACTUAL, SUBDOMINIO_ACTUAL, $this->vkey . '=$p1');
    ...
    $html .= "<ul class=\"pagination\" data-id=\"" . $this->id . "\">";
    if(!empty($this->previous)) {
      $html .= "<li class=\"paginate_button page-item previous\"><a class=\"page-link\" data-in-popy href=\"" . $link_anterior . "\" " . $attrs . ">Anterior</a></li>";
    } else {
      $html .= "<li class=\"paginate_button page-item previous disabled\"><a class=\"page-link\">Anterior</a></li>";
    }
...
//    $html .= "<small>Se ha encontrado " . $this->number_results . " resultado" . ($this->number_results == 1 ? '' : 's') . "</small>";
    ...
    foreach($indices as $i) {
      ...
      if($i == '...') {
        $html .= "<li class=\"paginate_button page-item\"><span class=\"pagination-ellipsis\">&hellip;</span></li>";
      } elseif($i == $this->page) {
        $html .= "<li class=\"paginate_button page-item active\"><a class=\"page-link is-current\" aria-label=\"Ir página " . $i . "\" href=\"" . $link_i . "\" " . $attrs . ">" . $i . "</a></li>";
      } else {
        $html .= "<li class=\"paginate_button page-item\"><a class=\"page-link\" aria-label=\"Ir página " . $i . "\" href=\"" . $link_i . "\" " . $attrs . ">" . $i . "</a></li>";
      }
    }
    if(!empty($this->next)) {
      $html .= "<li class=\"paginate_button page-item next\"><a class=\"page-link\" data-in-popy href=\"" . $link_siguiente . "\" " . $attrs . ">Siguiente</a></li>";
    } else {
      $html .= "<li class=\"paginate_button page-item next disabled\"><a class=\"page-link\">Siguiente</a></li>";
    }
    $html .= "</ul>";
    $html .= "</div>";
    return $html;
